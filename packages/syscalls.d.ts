...
declare namespace api {
    ...
    export namespace window {
        export function open(type: "canvas", opts: t_opts): Promise<[number, HTMLCanvasElement]>;
        /**
         * @deprecated ~~LIFE IS PAIN~~ Use the new {@link events} system instead
         */
        export function nextEvent(id: number): Promise<Event>;
        export function close(id: number, force: boolean): Promise<void>;
    }
    export namespace events {
        export function registerEvent(id: number, name: string, handle: (ev: Event) => any, once: boolean): void;
        export function removeEvent(id: number, name: string, handle: (ev: Event) => any): void;
    }
}